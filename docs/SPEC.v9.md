...
**Mới trong bản này:** thêm vai trò **Board Admin** — quyền admin giới hạn theo 1 board cụ thể (không phải admin toàn công ty), gán được lúc tạo/cài đặt board (mục 2.3a). Phạm vi quyền: kiểm duyệt + cài đặt board đó, KHÔNG quản lý thành viên/phòng ban/công ty.
