...
**Mới trong bản này:** thêm tính năng sửa ghim sau khi đăng (mục 2.5a); cải thiện UI/UX form tạo ghim — mini-render thật cho 7 template thay vì ô màu phẳng, khoá Polaroid gắn trực tiếp lên ô, đổi thứ tự field, style lại control mặc định trình duyệt (mục 2.5b). **Giả định đã chọn** (chưa hỏi lại bạn): sửa ghim không giới hạn thời gian, luôn hiện nhãn "đã chỉnh sửa" — nếu muốn giới hạn theo khung giờ, báo lại để đổi.
