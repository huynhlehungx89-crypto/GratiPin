...
**Mới trong bản này:** Admin có thêm nút **"Ẩn ghim" ngay trên bảng** (không chỉ ở trang Kiểm duyệt riêng) — thao tác nhanh khi đang xem board thật (mục 2.6d, 2.9 cập nhật).
