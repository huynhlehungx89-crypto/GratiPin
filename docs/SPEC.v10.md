...
**Mới trong bản này:** làm rõ điểm truy cập UI còn thiếu ở v9 — mỗi board (kể cả Bảng chung công ty) phải có **icon/nút "Cài đặt bảng" hiển thị rõ ràng** trên chính màn hình board, dẫn tới trang cài đặt skin/embed/Board Admin đã có ở v9 (mục 2.6 cập nhật).
...
- [ ] Nav item "Kiểm duyệt" hiện **icon chấm than đỏ** khi có ghim mới đăng mà Admin **chưa từng mở trang Kiểm duyệt để xem qua**
- [ ] Nhắc lại nguyên tắc: ghim đăng lên **luôn lên bảng ngay lập tức** (không có hàng chờ duyệt trước) — trang Kiểm duyệt chỉ là **danh sách rà soát**, giúp Admin lướt nhanh và gỡ ghim không phù hợp, không phải cổng chặn
- [ ] Khi Admin mở trang Kiểm duyệt: toàn bộ ghim đang "chưa xem" tại thời điểm đó được đánh dấu đã xem → badge đỏ biến mất
- [ ] Ghim đăng sau thời điểm đó lại tính là "mới", badge đỏ hiện lại
