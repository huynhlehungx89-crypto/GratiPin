...
**Mới trong bản này:** đổi thứ tự form tạo ghim — Ảnh lên đầu tiên, đổi tên "Ảnh đính kèm" thành "Ảnh"; **nội dung chữ trở thành tuỳ chọn nếu đã có ảnh** — chỉ bắt buộc phải có ít nhất 1 trong 2 (mục 2.5, 2.5b).
