...
**Mới trong bản này:** tái cấu trúc menu điều hướng — "Bảng ghim" thành dropdown chọn bảng + đặt bảng mặc định (mục 2.6b); gộp "Thành viên/Phòng ban/Cài đặt" vào 1 menu "Cài đặt" (mục 2.6c); badge cảnh báo trên "Kiểm duyệt" khi có ghim mới chưa xem (mục 2.9a).
...
- [ ] Thứ tự field trong form: **Nội dung → Ảnh đính kèm → Mẫu ghim → Bảng đích → Người nhận (tuỳ chọn) → Đăng ẩn danh** — đưa Ảnh lên trước Mẫu ghim vì Polaroid phụ thuộc vào việc đã có ảnh hay chưa
